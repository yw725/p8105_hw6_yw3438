...
From the distribution of log(beta0_hat * beta1_hat) has little extending tail on the left side and is almost symmetric, which indicates that there are almost no outliers in the bootstrap sample.
