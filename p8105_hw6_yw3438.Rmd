...
The birth weight is an outcome that may depend on 'mother's weight gain during pregnancy' and 'mother's race'. We fit the initial model in the following code.
